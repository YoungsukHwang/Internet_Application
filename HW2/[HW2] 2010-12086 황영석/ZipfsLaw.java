...
package kr.ac.snu.imlab.ia.hw2.zipf;

import java.io.IOException;

import kr.ac.snu.imlab.ia.hw2.tokenizer.TokenizerExample;
import kr.ac.snu.imlab.ia.hw2.types.ZipfCount;
...
//        stage.add(new Step(TagTokenizer.class));    // TODO: 2-1.에서 주석 처리 해제, 2-2.에서 주석 처리   이게 전부ㅋㅋ
        stage.add(new Step(TokenizerExample.class));    // TODO: 2-2.에서 주석 처리 해제, 2-1.에서 주석 처리
    ...
    @OutputClass(className = "kr.ac.snu.imlab.ia.hw2.types.ZipfCount")
    @Verified
     ...
     * is (total, count).
     */
    @InputClass(className = "kr.ac.snu.imlab.ia.hw2.types.ZipfCount")
    @OutputClass(className = "kr.ac.snu.imlab.ia.hw2.types.ZipfCount")
    @Verified
